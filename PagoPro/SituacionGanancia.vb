...
Public Class SituacionGanancia

    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Me.Close()
    End Sub

    Private Sub SituacionGanancia_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim sql As String
        sql = "Select sig_Cod,sig_Desc from [manager].[dbo].[SituGan] "
